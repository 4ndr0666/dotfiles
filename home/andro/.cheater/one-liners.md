...
## Truncate Filename
 ...
 - This will rename "20221227 2210 - Random TV Chanel HD - Make Arch Great Again.ts" to "Make Arch Great Again.ts": 
...
## WGET: All Images From Website All Images
...
## Rm Files That Dont Match Extensions 
...
- A background processes PID can be limited using a scale of 0 - 100 times the number of CPU cores. Example, 4 cores = 0 - 400.
...
sudo ln -s /usr/lib/example.so.2.0 /usr/lib/example.so..338
```
