...
(function() {
    ...
    const CUSTOM_ENGINES = [
        {
            name: 'Bunkrr', // site name that will be displayed
            searchUrl: 'https://bunkr-albums.io/?search=%s', // place search url here and replace your search request with "%s" (without quotes)
            ...
            //isExample: ture, // do not include this property in your custom engine
        },
        // For Example:
        {
            name: 'EPorner',
